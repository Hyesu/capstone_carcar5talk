...
public class CarView extends SurfaceView implements Callback {
	...
	public static class MyHandler extends Handler {
		...
		private final WeakReference<CarView> myClassWeakReference;

		public MyHandler(CarView myCarViewInstance) {
			myClassWeakReference = new WeakReference<CarView>(myCarViewInstance);
		}

		@Override
		public void handleMessage(Message msg) {
			CarView myCarView = myClassWeakReference.get();
			if (myCarView != null) {
				switch (msg.what) {
				case MESSAGE_READ:
